    ...
    <Layout location={location} title={siteTitle}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Digital Income.
          </p>
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Digital Income, accessible from{" "}
          <a href="https://digincome.com/">https://digincome.com/</a>
        </li>{" "}
        <li>
      ...
      <ul>
        <li>
          ...
          <p>
            The Digital Income websites uses Google Analytics as its primary
            solution for tracking website visits, interactions and events. we
            use website analytics data to help improve the way we delivery
            content and online experiences to visitors.
          </p>
          <p>
      ...
      <ul>
        <li>By email: incomedig@gmail.com</li>
      </ul>
    </Layout>
  )
}
